...
import ProductAttributeActions from '../product-attribute/product-attribute.reducer';
...
const validationSchema = Yup.object().shape({
  ...
  productAttribute: Yup.mixed().required(),
});
...
function ProductEditScreen(props) {
  ...
  React.useEffect(() => {
    ...
    getAllProductCategories();
    getAllProductAttributes();
  }, [getAllShops, getAllProductCategories, getAllProductAttributes]);
  ...
  const productAttributeRef = createRef();
        ...
        {formValue && (
          <Form initialValues={formValue} validationSchema={validationSchema} onSubmit={onSubmit} ref={formRef}>
            ...
            <FormField
              ...
              listItems={productAttributeList}
              listItemLabelField="name"
              label="Product Attribute"
              placeholder="Select Product Attribute"
              testID="productAttributeSelectInput"
            />
...
const entityToFormValue = (value) => {
  ...
  return {
    ...
    productAttribute: value.productAttribute && value.productAttribute.id ? value.productAttribute.id : null,
  };
};
const formValueToEntity = (value) => {
  ...
  entity.productAttribute = value.productAttribute ? { id: value.productAttribute } : null;
  return entity;
};
