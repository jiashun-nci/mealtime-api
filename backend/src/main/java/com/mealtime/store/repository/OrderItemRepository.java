...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query(
        value = "select distinct orderItem from OrderItem orderItem left join fetch orderItem.product",
    ...
    @Query("select distinct orderItem from OrderItem orderItem left join fetch orderItem.product")
