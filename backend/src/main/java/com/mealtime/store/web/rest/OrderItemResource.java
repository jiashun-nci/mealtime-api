...
/**
 * REST controller for managing {@link com.mealtime.store.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemResource {
    ...
    public List<OrderItem> getAllOrderItems(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
