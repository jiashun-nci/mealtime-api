...
/**
 * REST controller for managing {@link com.mealtime.store.domain.Shop}.
 */
@RestController
@RequestMapping("/api")
public class ShopResource {
    ...
    public ResponseEntity<Shop> partialUpdateShop(
        ...
        Optional<Shop> result = shopService.partialUpdate(shop);
    ...
    public ResponseEntity<List<Shop>> getAllShops(
        ...
        Page<Shop> page;
        if (eagerload) {
            page = shopService.findAllWithEagerRelationships(pageable);
        } else {
