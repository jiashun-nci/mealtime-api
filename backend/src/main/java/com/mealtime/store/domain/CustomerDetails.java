...
public class CustomerDetails implements Serializable {
    ...
    public CustomerDetails birthday(LocalDate birthday) {
    ...
    public CustomerDetails avatar(byte[] avatar) {
    ...
    public CustomerDetails avatarContentType(String avatarContentType) {
