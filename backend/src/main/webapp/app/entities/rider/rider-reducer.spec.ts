...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rider.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_RIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RIDER actions', async () => {
      const expectedActions = [
        {
