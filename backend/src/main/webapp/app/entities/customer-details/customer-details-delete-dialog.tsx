...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mealtimeApp.customerDetails.delete.question">
        <Translate contentKey="mealtimeApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
