  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mealtimeApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="mealtimeApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('mealtimeApp.productCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.productCategory.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('mealtimeApp.productCategory.categoryImage')}
                id="product-category-categoryImage"
                name="categoryImage"
