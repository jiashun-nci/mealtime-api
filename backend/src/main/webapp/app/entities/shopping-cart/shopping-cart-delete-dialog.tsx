...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mealtimeApp.shoppingCart.delete.question">
        <Translate contentKey="mealtimeApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
