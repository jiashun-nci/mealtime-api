...
import com.mealtime.store.repository.ProductCategoryRepository;
...
class ProductCategoryResourceIT {
    ...
    void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getCategoryImage()).isEqualTo(DEFAULT_CATEGORY_IMAGE);
        assertThat(testProductCategory.getCategoryImageContentType()).isEqualTo(DEFAULT_CATEGORY_IMAGE_CONTENT_TYPE);
    }
    ...
    void putExistingProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getCategoryImage()).isEqualTo(UPDATED_CATEGORY_IMAGE);
        assertThat(testProductCategory.getCategoryImageContentType()).isEqualTo(UPDATED_CATEGORY_IMAGE_CONTENT_TYPE);
    }
