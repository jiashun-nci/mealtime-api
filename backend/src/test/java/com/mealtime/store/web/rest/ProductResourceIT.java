...
import com.mealtime.store.repository.ProductRepository;
import com.mealtime.store.service.ProductService;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, ProductAttribute.class).isEmpty()) {
            productAttribute = ProductAttributeResourceIT.createEntity(em);
            em.persist(productAttribute);
            em.flush();
        } else {
            productAttribute = TestUtil.findAll(em, ProductAttribute.class).get(0);
        }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        ...
        ProductAttribute productAttribute;
        if (TestUtil.findAll(em, ProductAttribute.class).isEmpty()) {
            productAttribute = ProductAttributeResourceIT.createUpdatedEntity(em);
            em.persist(productAttribute);
            em.flush();
        } else {
            productAttribute = TestUtil.findAll(em, ProductAttribute.class).get(0);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.active(UPDATED_ACTIVE).featured(UPDATED_FEATURED);
