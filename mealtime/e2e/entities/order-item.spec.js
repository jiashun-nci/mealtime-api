...
describe('OrderItem Screen Tests', () => {
  ...
  it('should allow you to create, update, and delete the OrderItem entity', async () => {
    ...
    await setDateTimePickerValue('placedDateInput', '2023-07-30T00:35:00+01:00', 'ISO8601');
    // quantity
    ...
    jestExpect(Date.parse(placedDateCreateAttributes.label)).toEqual(Date.parse('2023-07-30T00:35:00+01:00'));
    // quantity
    ...
    // placedDate
    await scrollTo('placedDateInput', 'orderItemEditScrollView');
    await setDateTimePickerValue('placedDateInput', '2023-07-30T04:45:00+01:00', 'ISO8601');
    // quantity
    await scrollTo('quantityInput', 'orderItemEditScrollView');
    ...
    jestExpect(Date.parse(placedDateUpdateAttributes.label)).toEqual(Date.parse('2023-07-30T04:45:00+01:00'));
    // quantity
    await scrollTo('quantity', 'orderItemDetailScrollView');
