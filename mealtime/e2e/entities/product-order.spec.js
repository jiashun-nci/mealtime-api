...
describe('ProductOrder Screen Tests', () => {
  ...
  it('should allow you to create, update, and delete the ProductOrder entity', async () => {
    ...
    await setDateTimePickerValue('placedDateInput', '2023-07-30T14:26:00+01:00', 'ISO8601');
    // quantity
    ...
    jestExpect(Date.parse(placedDateCreateAttributes.label)).toEqual(Date.parse('2023-07-30T14:26:00+01:00'));
    // quantity
    ...
    // placedDate
    await scrollTo('placedDateInput', 'productOrderEditScrollView');
    await setDateTimePickerValue('placedDateInput', '2023-07-30T17:17:00+01:00', 'ISO8601');
    // quantity
    await scrollTo('quantityInput', 'productOrderEditScrollView');
    ...
    jestExpect(Date.parse(placedDateUpdateAttributes.label)).toEqual(Date.parse('2023-07-30T17:17:00+01:00'));
    // quantity
    await scrollTo('quantity', 'productOrderDetailScrollView');
