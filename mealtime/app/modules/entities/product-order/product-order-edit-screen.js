...
function ProductOrderEditScreen(props) {
  ...
  const shoppingCartRef = createRef();
...
const entityToFormValue = (value) => {
  ...
  return {
    ...
    shoppingCart: value.shoppingCart && value.shoppingCart.id ? value.shoppingCart.id : null,
  };
};
const formValueToEntity = (value) => {
  ...
  entity.shoppingCart = value.shoppingCart ? { id: value.shoppingCart } : null;
  return entity;
};
