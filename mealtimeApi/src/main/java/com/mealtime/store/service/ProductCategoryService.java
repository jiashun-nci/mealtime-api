    ...
    public Optional<ProductCategory> partialUpdate(ProductCategory productCategory) {
        ...
        return productCategoryRepository
            ...
            .map(existingProductCategory -> {
                ...
                if (productCategory.getCategoryImage() != null) {
                    existingProductCategory.setCategoryImage(productCategory.getCategoryImage());
                }
                if (productCategory.getCategoryImageContentType() != null) {
                    existingProductCategory.setCategoryImageContentType(productCategory.getCategoryImageContentType());
                }
