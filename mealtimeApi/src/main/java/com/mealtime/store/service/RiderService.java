...
public class RiderService {
    ...
    /**
     * Get all the riders with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<Rider> findAllWithEagerRelationships(Pageable pageable) {
        return riderRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Rider> findOne(Long id) {
        ...
        return riderRepository.findOneWithEagerRelationships(id);
    }
