        ...
        return customerDetailsRepository
            ...
            .map(existingCustomerDetails -> {
                ...
                if (customerDetails.getBirthday() != null) {
                    existingCustomerDetails.setBirthday(customerDetails.getBirthday());
                }
                ...
                if (customerDetails.getAvatar() != null) {
                    existingCustomerDetails.setAvatar(customerDetails.getAvatar());
                }
                if (customerDetails.getAvatarContentType() != null) {
                    existingCustomerDetails.setAvatarContentType(customerDetails.getAvatarContentType());
                }
