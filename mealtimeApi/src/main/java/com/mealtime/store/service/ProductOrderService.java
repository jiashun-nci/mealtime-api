    ...
    public Optional<ProductOrder> partialUpdate(ProductOrder productOrder) {
        ...
        return productOrderRepository
            ...
            .map(existingProductOrder -> {
                ...
                if (productOrder.getPaymentMethod() != null) {
                    existingProductOrder.setPaymentMethod(productOrder.getPaymentMethod());
                }
                if (productOrder.getPaymentReference() != null) {
                    existingProductOrder.setPaymentReference(productOrder.getPaymentReference());
                }
