...
import com.mealtime.store.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link com.mealtime.store.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartResource {
    ...
    public ResponseEntity<List<ShoppingCart>> getAllShoppingCarts(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
