...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mealtimeApp.productOrder.delete.question">
        <Translate contentKey="mealtimeApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
