  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mealtimeApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="mealtimeApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.name')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('mealtimeApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.birthday')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('mealtimeApp.customerDetails.country')}
              ...
              />
              <ValidatedBlobField
                label={translate('mealtimeApp.customerDetails.avatar')}
                id="customer-details-avatar"
                name="avatar"
                data-cy="avatar"
                isImage
                accept="image/*"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('mealtimeApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
