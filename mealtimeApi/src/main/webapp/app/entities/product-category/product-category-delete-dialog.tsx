...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mealtimeApp.productCategory.delete.question">
        <Translate contentKey="mealtimeApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
