...
export const ShopDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mealtimeApp.shop.delete.question">
        <Translate contentKey="mealtimeApp.shop.delete.question" interpolate={{ id: shopEntity.id }}>
