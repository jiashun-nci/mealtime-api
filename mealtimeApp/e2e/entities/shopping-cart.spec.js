...
describe('ShoppingCart Screen Tests', () => {
  ...
  it('should allow you to create, update, and delete the ShoppingCart entity', async () => {
    ...
    await setDateTimePickerValue('placedDateInput', '2023-08-03T05:15:00+01:00', 'ISO8601');
    // quantity
    ...
    jestExpect(Date.parse(placedDateCreateAttributes.label)).toEqual(Date.parse('2023-08-03T05:15:00+01:00'));
    // quantity
    ...
    // placedDate
    await scrollTo('placedDateInput', 'shoppingCartEditScrollView');
    await setDateTimePickerValue('placedDateInput', '2023-08-03T16:20:00+01:00', 'ISO8601');
    // quantity
    await scrollTo('quantityInput', 'shoppingCartEditScrollView');
    ...
    jestExpect(Date.parse(placedDateUpdateAttributes.label)).toEqual(Date.parse('2023-08-03T16:20:00+01:00'));
    // quantity
    await scrollTo('quantity', 'shoppingCartDetailScrollView');
