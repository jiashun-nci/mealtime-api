...
describe('CustomerDetails Screen Tests', () => {
  ...
  it('should allow you to create, update, and delete the CustomerDetails entity', async () => {
    ...
    await setDateTimePickerValue('birthdayInput', '08/03/23', 'MM/dd/yy');
    // addressLine1
    ...
    jestExpect(Date.parse(birthdayCreateAttributes.label)).toEqual(Date.parse('08/03/23'));
    // addressLine1
    ...
    jestExpect(Date.parse(birthdayUpdateAttributes.label)).toEqual(Date.parse('08/03/23'));
    // addressLine1
    await scrollTo('addressLine1', 'customerDetailsDetailScrollView');
    await expect(element(by.id('addressLine1'))).toHaveLabel('Sports');
    // addressLine2
